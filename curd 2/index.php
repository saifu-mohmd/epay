...
if(isset($_POST['register'])){
 ...
 $ckecking="SELECT * FROM useraccount WHERE email ='$mail'";
 ...
 if($numb>0){
  ...
  $ins="INSERT INTO useraccount (username,email,password) VALUES ('$name','$mail','$password') ";
  $sql=mysqli_query($connet,$ins);
 }
